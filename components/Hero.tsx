...
export default function Hero() {
  ...
  return (
    <>
      ...
      <section className="absolute h-screen inset-y-0 left-8 flex flex-col justify-center">
        <p className="text-white italic font-bold text-3xl sm:text-5xl">
          {heroTxt}
        </p>
        {isHome && (
          <Image
            ...
            height={325}
            alt="nbm_white.png"
            className="xl:w-60 sm:w-[200px] w-[150px]"
          />
        )}
      </section>
    </>
